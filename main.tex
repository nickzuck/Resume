...
Adding new features and Enhancements of existing features in CollegeDunia and Frizza . Created an internal software for Human Resource Management from scratch. Created self hosted email marketing service (with Postfix) and API to handle the same from scratch.\\
\\
