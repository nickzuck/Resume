...
%----------------------------------------------------------------------------------------
\section{Experience}
\textbf{Backend Developer, \href{https://testbook.com}{Testbook Edu Solutions Pvt. Ltd., Navi Mumbai}} \hfill Sept, 2018 - Now\\
\emph{\color{BlueViolet}Golang $\vert$ MongoDB $\vert$ Redis $\vert$ RabbitMQ } \\
Developing fast and scalable APIs to handle high traffic from both web and app. Improved existing code and solved minor and major bugs in transaction APIs. \\
\\
...
Added new features and Enhancements of existing features in CollegeDunia and Frizza. Created an internal software for Human Resource Management from scratch. Created self hosted email marketing service (with Postfix) and API to handle the same from scratch.\\
...
\textbf{Languages}
\begin{itemize}
	\item \textbf{Proficient} - Python, C++, MySQL
	\item \textbf{Other} - MongoDB, Postgres
\end{itemize} 
