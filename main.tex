...
\emph{\color{BlueViolet}Django $\vert$ Python $\vert$ PHP $\vert$ MySQL $\vert$ Postgres $\vert$ Redis} \\
Adding new features and Enhancements of existing features in CollegeDunia and Frizza. Created an internal software for Human Resource Management. \\
\\
...
\textbf{Languages}
\begin{itemize}
	\item \textbf{Proficient} - Python, C++, MySQL, HTML, CSS, 
	\item \textbf{Other} - Postgres
\end{itemize} 
...
\begin{itemize}[leftmargin=*]
 ...
 Website of eCell MSIT with Payments system for Internship Fair.
...
\begin{itemize}[leftmargin=*]
 ...
 \item Appreciation certificate for Technical Team at eCell MSIT
